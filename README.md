...
### `Results_ABFEP/`
Results of ABFEP calculations: one spreadsheet for the congeneric compound series for eight proteins (`Results_ABFEP/Congeneric_8proteins_ABFEP.xlsx`), the other spreadsheet for the virtual screening of JAK2 (`Results_ABFEP/JAK2_VS_ABFEP.xlsx`), and output fmp files in folders `Output_fmp_holo` and `Output_fmp_apo`.
